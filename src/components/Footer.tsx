    ...
    <footer className="bg-base-100 border-t border-base-300">
      <div className="footer max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div>
          <Link
            href="/"
            className="footer-title text-xl opacity-100 text-base-content hover:text-primary transition-colors"
          >
            Lenkalica
          </Link>
          <p className="text-base-content/70 max-w-xs">Joys of the world at your fingertips</p>
        </div>
